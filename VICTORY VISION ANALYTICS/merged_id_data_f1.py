...
# Add unique ID for drivers starting from 1
df_final['driver_id'] = range(1, len(df_final) + 1)

# Reorder columns to make 'driver_id' the first column
cols = ['driver_id'] + [col for col in df_final.columns if col != 'driver_id']
df_final = df_final[cols]

# Save final DataFrame to CSV
print(df_final.head())
output_file = "f1_datas_id.csv"
